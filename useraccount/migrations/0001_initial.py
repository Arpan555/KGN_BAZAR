    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_name', models.CharField(blank=True, max_length=50, verbose_name='comapny name')),
                ('address1', models.CharField(blank=True, max_length=400, verbose_name='address line 01')),
                ('address2', models.CharField(blank=True, max_length=400, verbose_name='address line 02')),
                ('country', models.CharField(blank=True, max_length=50, verbose_name='country')),
                ('town', models.CharField(blank=True, max_length=80, verbose_name='town')),
                ('district', models.CharField(blank=True, max_length=80, verbose_name='district')),
                ('postcode', models.IntegerField(blank=True, null=True, verbose_name='postcode/zipcode')),
